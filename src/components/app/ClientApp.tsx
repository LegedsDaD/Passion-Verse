...
export default function ClientApp() {
  ...
  const handleDeleteRoadmap = async (id: string) => {
    requireAuth(async () => {
      if (!window.confirm("Delete this roadmap from My Roadmaps?")) return;
                ...
                <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-bold text-white shadow-md transition-all hover:bg-purple-600 active:scale-95 dark:bg-white dark:text-neutral-900 dark:hover:bg-purple-500 dark:hover:text-white"
                    >
                ...
                {myLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-300 bg-white/50 p-12 text-center dark:border-neutral-700 dark:bg-neutral-900/50">
                    ...
                    <p className="mt-1 mb-5 max-w-sm text-sm text-neutral-500 dark:text-neutral-400">
                      Start one by telling us what you want to do. Gemini will write the right
                      number of questions and build your plan.
                    </p>
                    <button
                      onClick={() => handleStartInterview()}
